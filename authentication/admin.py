...
class PasswordResetTokenAdmin(admin.ModelAdmin):
    list_display = ('user', 'token', 'expires_at', 'is_expired', 'created_at', 'delete_action')
...
class DeviceVerifyOTPAdmin(admin.ModelAdmin):
    list_display = ('user', 'device_id', 'otp', 'expires_at', 'is_expired', 'created_at', 'delete_action')
...
class LoginOTPAdmin(admin.ModelAdmin):
    list_display = ('user', 'otp', 'expires_at', 'is_expired', 'created_at', 'delete_action')
